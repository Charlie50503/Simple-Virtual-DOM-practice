...
var renderElem = function renderElem(_ref) {
  ...
  var $el = document.createElement(tagName); //set attribute
...
var _createElement = _interopRequireDefault(require("./vdom/createElement.js"));
...
var createVApp = function createVApp(count) {
  return (0, _createElement.default)("div", {
    ...
    children: [(0, _createElement.default)("input"), String(count), (0, _createElement.default)("img", {
      attrs: {
...
var count = 0;
var vApp = createVApp(count); //渲染成real dom

var $app = (0, _render.default)(vApp); //貼到html上
...
console.log($app);
},{"./vdom/createElement.js":"vdom/createElement.js","./vdom/render.js":"vdom/render.js","./vdom/mount.js":"vdom/mount.js","./vdom/diff.js":"vdom/diff.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
